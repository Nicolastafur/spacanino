...
?>
        ...
        <body>
            ...
            <form action="upd.php" method="POST" class="form" style="height: 395px;">
                ...
                <div class="input-container ic1">
                    ...
                    <input type="text" id="inp2" name="nombre" value="<?php echo $editar['nombre_auxiliar'] ?>" class="input">
                ...
                <div class="input-container ic1">
                    ...
                    <input type="text" id="inp4" name="usua" value="<?php echo $editar['apellido_auxiliar'] ?>" class="input">
