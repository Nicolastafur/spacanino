        ...
        <body>
            ...
            <form action="upd.php" method="POST" class="form" style="height: 420px;">
                ...
                <div class="input-container ic1">
                    ...
                    <input class="input" type="text" id="inp2" name="nombre" value="<?php echo $editar['nombre_recepcionista'] ?>">
                    <label id="lab2" class="placeholder">Nombre:</label>
                </div>
                <div class="input-container ic1">


                    <input class="input" type="text" id="inp4" name="usua" value="<?php echo $editar['apellido_recepcionista'] ?>">
